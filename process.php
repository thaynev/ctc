...
if(isset($_POST['contact_name']) != ""){
			...
			$message = "&nbsp;&nbsp;&nbsp;&nbsp;<strong>Cliente: </strong>".$_POST["contact_name"]."<br />";
			$message .= "&nbsp;&nbsp;&nbsp;&nbsp;<strong>E-mail: </strong>".$_POST["contact_email"]."<br />";
			$message .= "&nbsp;&nbsp;&nbsp;&nbsp;<strong>Telefone: </strong>".$_POST["contact_subject"]."<br />";
			$message .= "&nbsp;&nbsp;&nbsp;&nbsp; <strong>Mensagem: </strong>".$_POST["message"]."<br />";
			$subject = 'Cliente IMPORTANTE';		
